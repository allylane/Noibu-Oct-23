...
export function Hero() {
  return (
    <Container className="pb-16 pt-20 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium text-slate-900 sm:text-7xl">
      Optimize your online store with <span class="editorial-italic text-blue-800">next-level</span> performance monitoring.
      </h1>
